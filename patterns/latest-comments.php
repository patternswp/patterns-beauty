 ...
 * Slug: patterns-beauty/latest-comments
 * Categories: posts
...
<h4 class="wp-block-heading" style="margin-bottom:var(--wp--preset--spacing--30)"><?php esc_html_e( 'Recent comments', 'patterns-beauty' ); ?></h4>
<!-- /wp:heading -->
