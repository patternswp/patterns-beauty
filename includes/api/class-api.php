 ...
 * @subpackage Patterns_Beauty/includes/api
 */
 ...
 */
if ( ! class_exists( 'Patterns_Beauty_Api' ) ) {
	 ...
	 * @since 1.0.1
	 */
	class Patterns_Beauty_Api extends WP_REST_Controller {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'patterns-beauty' ), '1.0.0' );
		}
